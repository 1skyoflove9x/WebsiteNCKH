...
<label class="checkbox-inline"  style="margin-left:20px;">
  <input type="checkbox" name="check" id="dongy" value="option1" required>Tôi đồng ý  hủy đề tài
</label>
</br>
</form>
           </form>   

	<button type="back" class="btn btn-default"onclick= "TroLai(); return false;">Trở Lại</button>    
  <button type="submit" name ="submit" id="sumit" class="btn btn-default">Xác nhận</button>
  <footer >
	<div class="container">
	<div class="row">
	<p>This is Footer</p>
