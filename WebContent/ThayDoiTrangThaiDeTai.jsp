                ...
                <tr>
                  ...
                  <td><c:out value="${row.TrangThai}"/></td>
                   ...
                   <td><button class="btn btn-primary" data-toggle="modal"
												data-target="#myModal${row.MaDeTai}">Thay Đổi Trạng Thái</button> <!-- Modal -->				
													...
													<div class="modal-content">
														<div class="modal-header">
															...
															<div class="modal-body">	
																  <form id="signupForm1"  action="Data/DB_Update_TrangThaiDeTai.jsp" method="post" class="form-horizontal">
     														 <input type="hidden" class="form-control"  name="madetai" id="madetai" value="${row.MaDeTai}">
     														 <select class="form-control" name="TrangThai">
															  <option value="Đề tài được duyệt thực hiện">Đề tài được duyệt thực hiện</option> 
															  <option value="Đề tài chờ phản biện">Đề tài chờ phản biện</option>
															   <option value="Đề tài đã phản biện">Đề tài đã phản biện</option>
															  <option value="Đề tài chờ nghiệm thu">Đề tài chờ nghiệm thu</option>
															  <option value="Đề tài đã nghiệm thu">Đề tài đã nghiệm thu</option>
															  <option value="Đề tài đã hủy">Đề tài đã hủy</option>
															  <option value="Đề tài đã gia hạn">Đề tài đã gia hạn</option>
																	</select>
															</br>
