...
<sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver"
	 ...
	 SELECT * 
           FROM DeTai,ThongTinCanBo,PhanCongNghiemThu,DeTai_SinhVien
            where DeTai.MaDeTai=PhanCongNghiemThu.MaDeTai 
            and DeTai.MaDeTai=DeTai_SinhVien.MaDeTai
            and PhanCongNghiemThu.MaCanBo=ThongTinCanBo.MaCanBo
