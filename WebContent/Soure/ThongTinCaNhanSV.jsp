...
<div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="email" class="form-control" id="inputText" placeholder="Nhập khoa trực thuộc..">
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="email" class="form-control" id="inputText" placeholder="Nhập ngành đang học..">
    </div>
...
<div class="form-group" style="margin-left:10px;margin-right:10px">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" name="name" id="kho" placeholder="Nhập khoa trực thuộc..">
    </div>
<label for="inputText" class="col-sm-2 control-label">Lớp<span class="rq"> * </span></label>
    <div class="col-sm-4">
      <input type="text" class="form-control" name="name" id="khoa" placeholder="Nhập lớp..">
    </div>
</br></br>
  </div>
...
<div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick= "Save(); return false;">Cập nhật</button>
      </div>
    </div>
  </div>
</div>
