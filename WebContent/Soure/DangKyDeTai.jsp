...
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox1" value="option1" style="margin-left:20px;">Tôi đồng ý đăng ký đề tài
</label>
</br></br>

  <div class="form-actions">
            
  <button type="submit" class="btn btn-default"onclick= "Save(); return true;">Đăng Ký</button>
