...
<body>
	<sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver"
	 ...
	 <sql:query dataSource="${snapshot}" var="result">
			...
			and DeTai_SinhVien.TrangThai='Đề tài chờ gia hạn'
	</sql:query>
	</c:if>
	 ...
	 <sql:query dataSource="${snapshot}" var="result">
			...
			and DeTai.MaDeTai=DeTai_SinhVien.MaDeTai
			and DeTai_SinhVien.MSSV=ThongTinSinhVien.MSSV
			and DeTai_SinhVien.TrangThai='Đề tài chờ duyệt gia hạn'
	</sql:query>
	</c:if>
   <div id="load"> 
          <div class="panel-group" align="center">
    <div class="panel panel-info">
      <div class="panel-heading" id="tieude" style="color: blue"><strong>Duyệt Gia Hạn Đề Tài</strong></div>
    </div>
    </div>
  											...
  											<div class="modal-dialog modal-sm">
												...
												<div class="modal-body">		
													    ...
													    <label class="checkbox-inline">
													    		<c:if test="${sessionScope.quyen == 'giangvien'}">
															 <input type="radio" name="TrangThai" id="TrangThai" value="Đề tài chờ duyệt gia hạn"> Duyệt
															</label>
															<label class="checkbox-inline">
															    <input type="radio"  name="TrangThai" id="TrangThai" value="Đề tài được phê duyệt thực hiện"> Từ Chối
															 
															    </c:if>
															    <c:if test="${sessionScope.quyen == 'nhanvienql'}">
															 <input type="radio" name="TrangThai" id="TrangThai" value="Đề tài được duyệt gia hạn"> Duyệt 
															</label>
															<label class="checkbox-inline">
															    <input type="radio"  name="TrangThai" id="TrangThai" value="Đề tài được phê duyệt thực hiện"> Từ Chối
															     </c:if>
