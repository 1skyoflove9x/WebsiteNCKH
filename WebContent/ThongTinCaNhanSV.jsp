...
SELECT * FROM ThongTinSinhVien,dangnhap WHERE ThongTinSinhVien.MSSV=dangnhap.uName 
...
<form id="signupForm1" action="Data/DB_update_TTSV.jsp" method="post" class="form-horizontal"  accept-charset="utf8">
</br></br>
  <c:forEach var="row" items="${result.rows}">
...
<label for="inputText" class="col-sm-2 control-label">Niên Khóa <span class="rq"> * </span></label>
    <div class="col-sm-4">
      <input type="text" class="form-control"  value="${row.NienKhoa}" name="NienKhoa" id="nienkhoa" placeholder="Nhập niên khóa..">
    </div>
</br>
  </div>
