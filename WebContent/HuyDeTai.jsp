  ...
  <div class="form-control-group" style="margin-left:1%;">
    ...
    <textarea class="form-control" name="lydo" id="lydo" rows="5"placeholder="Nhập lý do gia hạn đề tài"></textarea>
								...
								<div  class="col-xs-12 col-md-12  ">
									<div class="checkbox">
										<label>
											<input type="checkbox" name="TrangThai" id="xacnhan" value="Đề tài chờ hủy" required/>Tôi đã đồng ý cập nhật
										</label>
									</div>
									</br>
								</div>	
...
<div  class="col-xs-12 col-md-4 col-md-offset-8 ">
        ...
        <button  type="submit"  class="btn btn-primary" name="signup" value="Đăng ký">Cập nhật</button>
      </div>
      </div>
