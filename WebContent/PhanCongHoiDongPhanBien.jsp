...
<body>
	<sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver"
	 ...
	 <sql:query dataSource="${snapshot}" var="result">
			...
			and DeTai_SinhVien.TrangThai="Đề tài được duyệt thực hiện" 
	</sql:query>
   <div id="load"> 
                   ...
                   <td><button class="btn btn-primary" data-toggle="modal"
							...
							<div id="myModal${row.MaDeTai}" class="modal" role="dialog">
												...
												<div class="modal-body">		
     													 <form id="signupForm2"  action="Data/DB_insert_PhanBien.jsp" method="post" class="form-horizontal">
														<div class="col-xs-12 col-md-12">
														      <input type="hidden" class="form-control"  name="madetai" id="madetai" value="${row.MaDeTai}">
														    </div>
													    <label  class="col-xs-12 col-md-3">Giáo Viên Phản Biện <span class="rq">*</label>
															    <div class="col-xs-12 col-md-9">
															      <input type="text" class="form-control" name="TenCanBo" id="TenCanBo" placeholder="Nhập tên GV " minlength="6">
															    </br>
															    </div>
															    <label  class="col-xs-12 col-md-3">Mã Số Cán Bộ <span class="rq"> *</label>
															    <div class="col-xs-12 col-md-9">
															      <input type="text" class="form-control" name="GVHD" id="GVHD"  placeholder="Nhập mã cán bộ" minlength="6">
															    </br>
															    </div>
															    <label  class="col-xs-12 col-md-3">Ngày Phản Biện <span class="rq"> *</label>
															    <div class="col-xs-12 col-md-9">
															    ...
															    <div class="col-xs-12 col-md-12">
																	<div class="checkbox">
																		<label>
																			<input type="checkbox" name="TrangThai" id="xacnhan" value="Đề tài chờ phản biện" required/>xác nhận
																		</label>
																	</div>
																</div>
															</br></br></br>
