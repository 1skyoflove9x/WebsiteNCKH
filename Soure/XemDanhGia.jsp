	...
	<th></th>
              ...
              <tbody>
                <tr>
                  ...
                  <td> 
      <button class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">Xem Đánh Giá</button>
...
<form id="registration-form" class="form-horizontal">
    <textarea class="form-control" rows="5" name="name" id="ykien" minlength="9"  placeholder="Tính kinh tế chưa cao" disabled></textarea>
  </br>
           </form>   
