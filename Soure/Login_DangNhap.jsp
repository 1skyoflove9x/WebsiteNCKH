...
<ul class="nav navbar-nav">
 ...
 <div class="login-card">
  ...
  <input type="radio" id="sinhvien"  name="optionsRadios"  value="option1"> Sinh Viên
</label>
</div>
<div class="col-md-6">
<label class="checkbox-inline">
  <input type="radio" id="giangvien"   name="optionsRadios" value="option2"> Giảng Viên
  </label>
    </div>
   <div class="col-md-6">
     <label class="checkbox-inline">
  <input type="radio" id="nhanvienql"  name="optionsRadios"  value="option1"> Nhân Viên QL
</label>
</div>
<div class="col-md-6">
<label class="checkbox-inline">
  <input type="radio" id="admin"   name="optionsRadios" value="option2"> Admin
  </label>
    </br></br>
    </div>
