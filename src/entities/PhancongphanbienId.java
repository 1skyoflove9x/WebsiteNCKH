...
/**
 * PhancongphanbienId generated by hbm2java
 */
@Embeddable
public class PhancongphanbienId implements java.io.Serializable {

	private String maDeTai;
	private String maCanBo;

	public PhancongphanbienId() {
	}

	public PhancongphanbienId(String maDeTai, String maCanBo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PhancongphanbienId))
			return false;
		PhancongphanbienId castOther = (PhancongphanbienId) other;
